...
# IMPORTANT: Dynamically compute the absolute path to your server.py 
PATH_TO_YOUR_CURRENT_DIR = str(Path(__file__).parent.resolve())
print("PATH_TO_YOUR_CURRENT_DIR :: ", PATH_TO_YOUR_CURRENT_DIR)
PATH_TO_YOUR_MCP_SERVER_SCRIPT = "/home/amit/Code/ai-examples/todo_app/app/main_mcp_adk.py"
#str((Path(__file__).parent / "main_mcp_adk.py").resolve())
